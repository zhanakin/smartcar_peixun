...
int params[pagenum][num_in_onepage]={0};

static int8_t key_i,page=0,param_i=0,param_page=0,pos=4;

char param_name[pagenum][num_in_onepage][9]={
        {"pwm_freq",
        "pwm_duty",
        "exp_time",
        "th_bias",
...
void reinit()
{
    pwm_init(MOTORL_PWM_CH1,params[0][0],params[1][0]);
    pwm_init(MOTORL_PWM_CH2,params[0][0],params[1][1]);
    pwm_init(MOTORR_PWM_CH1,params[0][0],params[1][2]);
    pwm_init(MOTORR_PWM_CH2,params[0][0],params[1][3]);
    ...
    pwm_set_duty(ATOM1_CH1_P33_9,params[1][4]);

    kp_angle=(float)params[2][0]/100;
    ki_angle=(float)params[2][1]/100;
    kd_angle=(float)params[2][2]/100;
    i_max=params[2][3];
    angle_output_max=params[2][4];
    kp_speed=(float)params[3][0]/100;
    ki_speed=(float)params[3][1]/100;
    kd_speed=(float)params[3][2]/100;
}
int numlen(int n)
{
    int ret=1;
