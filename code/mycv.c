...
//    tft180_show_gray_image(0,80,mt9v03x_image[0],MT9V03X_W,MT9V03X_H,128,80,g_thres_value);
    tft180_show_gray_image(0,80,process_output_image[0],MT9V03X_W,MT9V03X_H,MT9V03X_W,MT9V03X_H,0);

    //中心线
    tft180_draw_line(WIDTH/2, 80, WIDTH/2, 159, RGB565_RED);
    //最长白列
    tft180_draw_line(longest_white_col_avg, 159-longest_white_num, longest_white_col_avg, 159, RGB565_BLUE);
    //前瞻行
    tft180_draw_line(0, 160-1-foresight_up_dy, WIDTH, 160-1-foresight_up_dy, RGB565_BLUE);
    tft180_draw_line(0, 160-1-foresight_down_dy, WIDTH, 160-1-foresight_down_dy, RGB565_BLUE);
    //左右边线
    for(int i=0;i<longest_white_num;++i)
    {
        tft180_draw_point(left_sideline[i], 159-i, RGB565_YELLOW);
        tft180_draw_point(right_sideline[i], 159-i, RGB565_YELLOW);
        tft180_draw_point(track_line[i], 159-i, RGB565_RED);
    }

//    tft180_show_uint(100,112,longest_white_col_avg,3);
//    tft180_show_uint(100,128,longest_white_num,3);
    tft180_show_float(84, 112, error, 2, 1);
